# Playtesting checklist, Tetra Refreshed
...
* [ ] The workbench, the holosphere and the toolbelt open, draw and close without error
* [ ] Tool and weapon stats match the behaviour upstream Tetra documents
* [ ] A module crafts onto an item, hones, and salvages back off
* [ ] Materials show in the recipe viewer with the stats the holosphere gives them

## Addon integration

* [ ] Each bundled addon loads beside the base fork with no conflict
* [ ] Addon recipes and items behave as expected
* [ ] Nothing is duplicated or missing in the recipe viewer once an addon is present
* [ ] A bundled addon is reported by the loader as its own mod, from inside this jar
...
* [ ] Works with anything that hooks into Tetra's own systems, its materials, modules, schematics and effects
